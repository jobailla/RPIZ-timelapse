    ...
    case $response in
        ...
        0)   clear
            ...
            then
                ...
                echo "alias timelapse=\"sudo python3 /home/pi/RPIZ-timelapse/timelapse.py\"" | sudo tee -a  ~/.bashrc > dev/null
                echo "alias witty=\"sudo /home/pi/wittyPi/wittyPi.sh\"" | sudo tee -a  ~/.bashrc > dev/null
                echo "alias rpicam=\"sudo python3 /home/pi/RPIZ-timelapse/test_camera.py\"" | sudo tee -a  ~/.bashrc > dev/null
            else
